"""
WAN 2.2 14B video generation FastAPI server.

Loads the WAN 2.2 14B model (t2v + i2v) at startup and serves generation requests.
...
from video_api.models.wan22 import load, generate
...
class GenerateRequest(BaseModel):
    ...
    height: int = 480
    width: int = 832
    num_frames: int = 161  # ~10s at 16fps
    fps: int = 16
